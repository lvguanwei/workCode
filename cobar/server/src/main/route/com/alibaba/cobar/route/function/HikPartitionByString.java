 ...
 */
public final class HikPartitionByString extends PartitionFunction implements RuleAlgorithm {
    public HikPartitionByString(String functionName) {
        this(functionName, null);
    }

    public HikPartitionByString(String functionName, List<Expression> arguments) {
    ...
    public RuleAlgorithm constructMe(Object... objects) {
        ...
        HikPartitionByString partitionFunc = new HikPartitionByString(functionName, args);
